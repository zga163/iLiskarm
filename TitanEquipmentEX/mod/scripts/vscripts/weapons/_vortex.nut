...
const VORTEX_SPHERE_COLOR_PAS_ION_VORTEX	= <93,68,190>	// purples   ion2
...
function CreateVortexSphere( entity vortexWeapon, bool useCylinderCheck, bool blockOwnerWeapon, int sphereRadius = 40, int bulletFOV = 180 )
{
	...
	Assert( owner )
		...
		/*if(SoulHasPassive( owner.GetTitanSoul(), ePassives.PAS_ION_VORTEX )){
			vortexSphere.kv.bullet_fov = 200
		}*/
